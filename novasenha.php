<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($senha != $senha2){
            die("Digite a mesma senha nos dois campos");
        }
        else{
        if($nome != "" && $email != "" && $senha != "" && $senha2 != ""){
            ...
            $sql = "UPDATE tb_usuarios SET Senha = '$senha' WHERE Nome = '$nome' AND email = '$email'";
            ...
            if($inserir){
                ...
                die("Falha na atualização de senha.");
            }
        }
    }
}
...
<body>
    ...
    <form method="post" >
        <div class="contabox">
            ...
            <div class="containerdados">
                <h6>Email: <input type="email" name="email"></h6>
            </div>
            <div class="containerdados">
                <h6>Nova Senha: <input type="password" name="senha"></h6>
            </div>
            <div class="containerdados">
                <h6>Confirme sua senha: <input type="password" name="senha2"></h6>
            </div>
            <input class="botaodados" type="submit" name="mudarsenha" value="Mudar Senha">
        </div>
    </form>
